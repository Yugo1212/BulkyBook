            ...
            if (ModelState.IsValid)
            {
                ...
                if(files.Count > 0)
                {
                    ...
                    if(productVM.Product.ImgUrl != null)
                    {
                        ...
                        var imagePath = Path.Combine(webRootPath, productVM.Product.ImgUrl.TrimStart('\\'));
                ...
                else
                {
                    ...
                    {
                        Product objFromFb = _unitOfWork.Product.Get(productVM.Product.Id);
                        productVM.Product.ImgUrl = objFromFb.ImgUrl;
                    }
                }
